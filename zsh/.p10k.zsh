# Generated by Powerlevel10k configuration wizard on 2022-05-14 at 13:40 EDT.
...
function prompt_reboot() {
  # if command -v check_reboot >/dev/null 2>&1 && check_reboot; then
  if checkreboot; then
...
function prompt_connection_path() {
  [[ -n "$SSH_CONNECTION_CHAIN_SHOW" ]] || return
